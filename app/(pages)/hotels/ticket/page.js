...
export default function HotelTicketDownloadPagee() {
  const breadcrumb = [
            ...
            <div className="mb-[40px] flex gap-[32px] p-[24px] flex-wrap">
              <div className="flex items-center gap-[8px]">
                ...
                <div>
                  ...
                  <p className="text-[0.75rem] font-medium">12:00pm</p>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
                <div className="min-h-[32px] min-w-[32px] rounded-[4px] bg-primary/20 p-[5px]">
                ...
                <div>
                  ...
                  <p className="text-[0.75rem] font-medium">11:30pm</p>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
                <div className="min-h-[32px] min-w-[32px] rounded-[4px] bg-primary/20 p-[5px]">
                ...
                <div>
                  ...
                  <p className="text-[0.75rem] font-medium">On arival</p>
                </div>
              </div>
            </div>
